        ...
        <div class="w-full md:w-1/2 flex flex-col items-center ">
            ...
            <h1 class="text-center text-2xl font-bold text-gray-600 mb-6">Entry Data Kontak</h1>
                ...
                <div class="w-3/4 mb-2">
                    <input type="text" name="no_Kontak" class="w-full py-4 px-8 bg-slate-200 placeholder:font-semibold rounded hover:ring-1 outline-blue-500 " placeholder="No HP"></input>
                </div>
